...
from PyQt6.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QTableWidget, 
                             ...
                             QGridLayout, QHeaderView, QGroupBox, QSplitter, QAbstractItemView)
...
class InventoryView(QWidget):
    ...
    def setup_ui(self):
        ...
        top_layout.addWidget(QLabel("<b>Current Available Stock</b>"))
        self.table_stock = QTableWidget()
        self.table_stock.setColumnCount(4)
        self.table_stock.setHorizontalHeaderLabels(["Product ID", "Product Name", "Qty Available", "Last Updated"])
        ...
        control_layout.addWidget(QLabel("Adjustment Qty:"), 0, 4)
        control_layout.addWidget(self.input_qty, 0, 5)
        
        control_layout.addWidget(self.btn_stock_in, 1, 4)
        control_layout.addWidget(self.btn_stock_out, 1, 5)
